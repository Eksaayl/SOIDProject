...
class _PartIDFormPageState extends State<PartIDFormPage> {
  ...
  Widget _buildCard(String label, TextEditingController ctrl,
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      return Scaffold(
        appBar: AppBar(title: Text('Part I.D')),
    ...
    return Scaffold(
      ...
      body: _isFinalized
        ...
        child: ListView(
          ...
          children: [
            _buildCard('Present ICT Situation (Strategic Challenges)',
                descCtl,
                multiline: true),
