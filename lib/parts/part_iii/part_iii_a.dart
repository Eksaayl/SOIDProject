...
class _PartIIIAState extends State<PartIIIA> {
  ...
  Future<String?> _generateAndUploadDocx() async {
    try {
      ...
      final url = Uri.parse('${Config.serverUrl}/generate-iii-a-docx/');
  ...
  Future<void> _showRemoveConfirmation(int index) async {
    final confirmed = await DialogUtils.showDeleteConfirmationDialog(
      ...
      message: 'Are you sure you want to remove Project ${index + 1}? This action cannot be undone.',
