...
class PartVCFormPage extends StatefulWidget {
  final String documentId;
  const PartVCFormPage({Key? key, required this.documentId}) : super(key: key);
  @override
  _PartVCFormPageState createState() => _PartVCFormPageState();
}

class _PartVCFormPageState extends State<PartVCFormPage> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        try {
          final docxRef = _storage.ref().child('$_yearRange/V.C/document.docx');
  ...
  Future<String> _uploadToStorage() async {
    ...
    final storageRef = _storage.ref()
        .child('$_yearRange/V.C/document.docx');
  ...
  Future<void> _generateAndUploadDocx() async {
    try {
      ...
      final templateRef = storage.ref().child('$_yearRange/V.C/V_c.docx');
  ...
  Future<void> _save({bool finalize = false}) async {
    ...
    try {
      ...
      if (finalize) {
        await createSubmissionNotification('Part V.C', _yearRange);
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Part V.C submitted for admin approval. You will be notified once it is reviewed.'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Part V.C saved successfully (not finalized)'),
  ...
  Future<void> _downloadTemplate() async {
    ...
    try {
      ...
      final fileName = 'V_c_template.docx';
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('V_c.docx template downloaded successfully!')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text(
            'Part V.C - Summary of Investments',
            style: TextStyle(
            ...
            ? Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Part V.C - Summary of Investments has been finalized.',
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                'Please upload a DOCX document for Part V.C. The document should contain all necessary information for the Summary of Investments section. You can download the template, fill it out, and then upload your completed document.',
                                style: TextStyle(
                                  fontSize: 16,
                              ...
                              Row(
                                children: [
                                  ElevatedButton.icon(
                                    ...
                                    label: const Text('Download V_c.docx Template'),
