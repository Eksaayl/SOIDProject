...
class DialogUtils {
  ...
  static Future<bool?> showSaveConfirmationDialog({
    required BuildContext context,
    required String title,
    required String message,
    String cancelText = 'Cancel',
  ...
  static Future<bool?> showApprovalConfirmationDialog({
    required BuildContext context,
    required String sectionName,
    String cancelText = 'Cancel',
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Are you sure you want to approve $sectionName? This action will finalize the section and mark it as approved.',
                          style: const TextStyle(
                            fontSize: 16,
  ...
  static Future<bool?> showUnfinalizeConfirmationDialog({
    required BuildContext context,
    required String sectionName,
    String cancelText = 'Cancel',
    String confirmText = 'Unfinalize',
  }) {
    return showDialog<bool>(
      context: context,
      builder: (BuildContext context) {
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Are you sure you want to unfinalize "$sectionName"? This will allow the section to be edited again.',
                          style: const TextStyle(
                            fontSize: 16,
