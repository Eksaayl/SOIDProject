...
class HistoryPage extends StatelessWidget {
  ...
  Future<void> _toggleFinalizedStatus(BuildContext context, DocumentSnapshot section) async {
    ...
    final confirmed = await DialogUtils.showUnfinalizeConfirmationDialog(
      context: context,
      sectionName: data['sectionTitle'] ?? section.id,
    );
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Section "${data['sectionTitle'] ?? section.id}" has been unfinalized successfully'),
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, userSnapshot) {
        ...
        return Scaffold(
          ...
          body: _buildSectionHistoryTab(sectionsRef, isAdmin),
        );
      },
    );
  }
